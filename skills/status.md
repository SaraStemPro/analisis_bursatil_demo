...
3. Cuenta los endpoints implementados vs los definidos en SPEC.md (actualmente 44 rutas)
...
9. Verifica las páginas del frontend (App.tsx routes + Navbar.tsx NAV_ITEMS) — 8 rutas (7 + /admin solo profesor)
