        ...
        {!isLoading && messages.length === 0 && (
          <div className="flex items-center justify-center h-full text-gray-400">
            <div className="text-center">
              ...
              <p className="text-xs mt-3 text-gray-400">Sube un PDF con el material y haz preguntas sobre el</p>
            </div>
          </div>
        )}
        ...
        {isSending && (
          <div className="flex justify-start">
            <div className="bg-gray-100 rounded-lg px-4 py-2">
              <p className="text-sm text-gray-500 animate-pulse">Pensando...</p>
            </div>
          </div>
        )}
      ...
      <div className="p-4 border-t border-gray-300">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2 bg-gray-100 border border-gray-300 rounded text-gray-900 placeholder-slate-400 focus:outline-none focus:border-emerald-500 text-sm"
          />
          <button
